...
[good first issue](https://github.com/croston-project/croston/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Bitcoin Core PR Review Club](https://crostoncore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Bitcoin Core development happens on IRC, in the
#croston-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/croston-core-dev/](http://www.erisian.com.au/croston-core-dev/)
and [http://gnusha.org/croston-core-dev/](http://gnusha.org/croston-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/croston-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to croston-qt
...
[Translation Process](https://github.com/croston-project/croston/blob/master/doc/translation_process.md)
...
https://github.com/croston-project/croston/pull/16189).

Also see the [backport.py script](
https://github.com/croston-core/croston-maintainer-tools#backport).
