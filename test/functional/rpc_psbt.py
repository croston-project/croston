...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 CROS
        ...
        # feeRate of 0.1 CROS / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 CROS / KB produces a total fee well above -maxtxfee
