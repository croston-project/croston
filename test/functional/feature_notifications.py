...
class NotificationsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/croston-project/croston/pull/9371, it might be better
            ...
            # https://github.com/croston-project/croston/pull/16624. The bug is reported
            # in issue https://github.com/croston-project/croston/issues/18325.
