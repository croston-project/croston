...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.crostond,
            self.options.crostond,
            releases_path + "/v0.19.0.1/bin/crostond",
            releases_path + "/v0.18.1/bin/crostond",
            releases_path + "/v0.17.1/bin/crostond"
        ], binary_cli=[
            self.options.crostoncli,
            self.options.crostoncli,
            releases_path + "/v0.19.0.1/bin/croston-cli",
            releases_path + "/v0.18.1/bin/croston-cli",
            releases_path + "/v0.17.1/bin/croston-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes crostond to exit, in addition to the RPC
