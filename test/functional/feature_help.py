...
"""Verify that starting croston with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start croston with -h for help text")
        ...
        self.log.info("Start croston with -version for version information")
        ...
        self.log.info("Start crostond with -fakearg to make sure it does not start")
