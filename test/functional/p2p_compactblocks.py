...
# TestP2PConn: A peer we use to send messages to crostond, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    def test_sendcmpct(self, test_node, old_node=None):
        ...
        # Make sure we get a SECROSMPCT message from our peer
        ...
        # Now try a SECROSMPCT message with too-high version
        ...
        # Now try a SECROSMPCT message with valid version, but announce=False
        ...
        # Finally, try a SECROSMPCT message with announce=True
        sendcmpct.version = preferred_version
        sendcmpct.announce = True
        test_node.send_and_ping(sendcmpct)
    ...
    # This test actually causes crostond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that crostond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for crostond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # crostond will not send blocktxn responses for blocks whose height is
    ...
    def run_test(self):
        ...
        self.log.info("Testing SECROSMPCT p2p message... ")
