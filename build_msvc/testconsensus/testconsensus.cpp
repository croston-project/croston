...
// croston includes.
#include <..\src\script\crostonconsensus.h>
...
int main()
{
    std::cout << "crostonconsensus version: " << crostonconsensus_version() << std::endl;
    ...
    auto op0Result = crostonconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, crostonconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
