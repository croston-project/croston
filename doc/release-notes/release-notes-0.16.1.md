Bitcoin Core version 0.16.1 is now available from:
  ...
  <https://crostoncore.org/bin/croston-core-0.16.1/>
...
- #12843 `df38b13` Test starting crostond with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure crostond processes are cleaned up when tests end (sdaftuar)
