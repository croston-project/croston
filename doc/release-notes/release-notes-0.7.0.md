Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/croston/files/Bitcoin/croston-0.7.0/

We recommend that everybody running prior versions of crostond/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/croston-project/croston/tarball/v0.7.0  # .tar.gz
  https://github.com/croston-project/croston/zipball/v0.7.0  # .zip
...
in your terminal, then install the croston-qt package:
  sudo apt-get install croston-qt
...
Core croston handling and blockchain database
...
* Ensure a changed croston unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for croston-qt.exe
* (Windows only): add meta-data to croston-qt.exe (e.g. description)
...
* Bash programmable completion for crostond(1)
