Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://croston.org/bin/croston-core-0.11.0/>
...
For example, add the following to `croston.conf`:
...
related to the blockchain in the croston system: the raw blocks as received over 
...
For an example script see [croston-submittx](https://github.com/laanwj/croston-submittx).
...
- #5334 `cf87536` libcrostonconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new croston-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add croston logo to about screen
...
- #5809 `46bfbe7` Add croston-cli man page
...
- #5849 `41259ca` contrib/init/crostond.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for croston-tx)
