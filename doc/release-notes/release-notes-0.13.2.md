Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://croston.org/bin/croston-core-0.13.2/>
...
- #8908 `4a974b2` Update croston-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow croston-tx to create v2 transactions (BTCdrak)
