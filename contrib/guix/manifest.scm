...
(define* (make-croston-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-croston-cross-toolchain "i686-linux-gnu")
       (make-croston-cross-toolchain "x86_64-linux-gnu")
       (make-croston-cross-toolchain "aarch64-linux-gnu")
       (make-croston-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-croston-cross-toolchain "riscv64-linux-gnu"
