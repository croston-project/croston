...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the croston repository."
  exit 1
fi
...
# See https://github.com/croston-project/croston/issues/16064
...
echo 'When compiling crostond, run `./configure` in the following way:'
echo
