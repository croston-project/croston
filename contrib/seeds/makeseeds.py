...
def main():
    ...
    # Filter out hosts with multiple croston ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple croston ports' % (ip_stats(ips)), file=sys.stderr)
