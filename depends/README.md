...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_croston` executable (see https://github.com/croston-project/croston/pull/13543),
...
options will be passed to croston's configure. In this case, `--disable-wallet`.
