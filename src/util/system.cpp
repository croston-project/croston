...
const char * const BITCOIN_CONF_FILENAME = "croston.conf";
 ...
 * https://github.com/croston-project/croston/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //croston-tx using stdin
        std::string val;
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Croston
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Croston
    // Mac: ~/Library/Application Support/Croston
    // Unix: ~/.croston
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Croston";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Croston";
#else
    // Unix
    return pathRet / ".croston";
#endif
#endif
}
