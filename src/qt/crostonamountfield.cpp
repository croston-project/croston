...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::CROS, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    int currentUnit{BitcoinUnits::CROS};
...
#include <qt/crostonamountfield.moc>
