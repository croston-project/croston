    ...
    mapper(nullptr)
{
    ...
    ui->crostonAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->crostonAtStartup);
    ...
    ui->crostonAtStartup->setToolTip(ui->crostonAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->crostonAtStartup->setText(ui->crostonAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->crostonAtStartup, OptionsModel::StartAtStartup);
