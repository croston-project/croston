...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Croston address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Croston : URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Croston addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Croston addresses"));
    ...
    openAction->setStatusTip(tr("Open a croston: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Croston network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
